...
class Circle extends Parent {
    ...
    <text x="50%" y="50%" font-size="75" text-anchor="middle" font-family="${this.fontFamily}" fill="${this.textColor}" dy=".35em">${this.text}</text>
</svg>`
	}
}
...
class Triangle extends Parent {
    ...
    <text x="50%" y="50%" font-size="60" text-anchor="middle" font-family="${this.fontFamily}" fill="${this.textColor}">${this.text}</text>
</svg>`
	}
}
...
class Square extends Parent {
	...
	render() {
		return `<svg width="${this.height}" height="${this.height}" xmlns="http://www.w3.org/2000/svg">
	<rect x="0" y="0" width="${this.height}" height="${this.height}" style="fill:${this.shapeColor};stroke-width:5;fill-opacity:1;stroke-opacity:1" />
	<text x="50%" y="50%" font-size="100" text-anchor="middle" dy="0.3em" font-family="${this.fontFamily}" fill="${this.textColor}">${this.text}</text>
</svg>`
	}
}
